...
insert into workout (workout_id, description, estimated_calories, estimated_duration, image_url, name, is_premium, level, coach_profile_coach_id, creator_user_id) values
...
insert into exercise (exercise_id, base_duration, base_rep_per_round, description, exercise_order, image_url, name, video_url, workout_workout_id)  values
