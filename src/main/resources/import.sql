...
insert into workout (workout_id, description, estimated_calories, estimated_duration, image_url, name, is_premium,
                     level, coach_profile_coach_id, creator_user_id)
values (0, 'Workout description here', 400, 600, 'workout_image.jpg', 'workout name 1', false, 1, 0, 2),
