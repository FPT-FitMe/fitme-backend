...
public class ExerciseService {
    ...
    public ExerciseDTO createExercise(Exercise exercise) {
    ...
    public ExerciseDTO createExercise(Exercise exercise, long workoutID) {
        Optional<AppUser> creator = appUserRepository.findById(exercise.getCreator().getUserID());
        if (!creator.isPresent()) throw new IllegalArgumentException("creatorID not found!");
    ...
    public ExerciseDTO patchExercise(Long id, JsonPatch patch) {
    ...
    public DisableExerciseDTO disableExercise(Long id, JsonPatch patch) {
        Optional<Exercise> currentExercise = exerciseRepository.findById(id);
